...
import {View, Image, Dimensions, StyleSheet, Linking, TouchableOpacity} from 'react-native';
import {
    Content,
    Text
} from 'native-base';
...
export class PrivacyContent extends React.PureComponent {
        ...
        return(
            <Content style={styles.mainContent}>
                ...
                <Text style={styles.mainHeaderText}>
                    Scroll down and type your name to agree to our consent to treat form:
                </Text>
                ...
                <Text style={styles.detailText}>Sam Wilson</Text>
                <TouchableOpacity onPress={() => Linking.openURL('mailto:sam@confidanthealth.com')}>
                    <Text style={styles.detailTextLink}>sam@confidanthealth.com</Text>
                </TouchableOpacity>
                <Text style={styles.detailText}>This policy is effective as of January 1 2022.</Text>
            </Content>
        );
    }
}
