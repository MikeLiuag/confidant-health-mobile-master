...
import {addTestID, AlertUtil, Colors, CommonStyles, TextStyles, PrimaryButton } from 'ch-mobile-shared';
import {Screens} from "../../constants/Screens";
import {NavigationActions, StackActions} from "react-navigation";


export default class GroupRewardPointsScreen extends Component {
    ...
    constructor(props) {
        ...
        this.groupInfo = navigation.getParam("groupInfo", null);
        this.state = {
            rewardSaved: false,
            luckyNumber: null,
            unit: null
            ...
            <Container style={{ backgroundColor: Colors.colors.screenBG }}>
                ...
                <Content
                    ...
                    <Text style={styles.rewardsSubTitle}>You’re doing great! {'\n'}
                        Here is your prize rewards.</Text>
                ...
                <View style={styles.btnStyle}>
                    <PrimaryButton
                        testId={this.state.rewardSaved && this.state.luckyNumber ? "Thanks Alfie!" : "I Feel Lucky"}
                        text={this.state.rewardSaved && this.state.luckyNumber ? "Thanks Alfie!" : "I Feel Lucky"}
                        onPress={() => {
